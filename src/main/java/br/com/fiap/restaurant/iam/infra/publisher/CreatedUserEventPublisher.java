...
public class CreatedUserEventPublisher implements EventPublisher<User> {

    private static final Logger log = LoggerFactory.getLogger(CreatedUserEventPublisher.class);

    public static final String USER_CREATE_EVENT_TYPE = "user.created";
    private final RabbitTemplate rabbitTemplate;

    public CreatedUserEventPublisher(RabbitTemplate rabbitTemplate) {
